! function () {
    ...
    var h = function (t) {
        ...
        m = function (t) {
            ...
            function o(t) {
                var n;
                return e(this, o), (n = a.call(this, t)).state = {
                    brkLength: 5,
                    seshLength: 25,
                    timerState: "stopped",
                    timerType: "Session",
                ...
                }, n.setBrkLength = n.setBrkLength.bind(s(n)), n.setSeshLength = n.setSeshLength.bind(s(n)), n.lengthControl = n.lengthControl.bind(s(n)), n.timerControl = n.timerControl.bind(s(n)), n.beginCountDown = n.beginCountDown.bind(s(n)), n.decrementTimer = n.decrementTimer.bind(s(n)), n.phaseControl = n.phaseControl.bind(s(n)), n.warning = n.warning.bind(s(n)), n.buzzer = n.buzzer.bind(s(n)), n.switchTimer = n.switchTimer.bind(s(n)), n.clockify = n.clockify.bind(s(n)), n.reset = n.reset.bind(s(n)), n
            }
            return n(o, [{
                key: "setBrkLength",
                value: function (e) {
                ...
                value: function (e, t, n, i) {
                    if ("running" !== this.state.timerState)
                        if (this.state.timerType === i) "-" === t && 1 !== n ? this.setState(r({}, e, n - 1)) : "+" === t && 60 !== n && this.setState(r({}, e, n + 1));
                        else if ("-" === t && 1 !== n) {
                            var a;
                            this.setState((r(a = {}, e, n - 1), r(a, "timer", 60 * n - 60), a))
                        } else if ("+" === t && 60 !== n) {
                            var o;
                            this.setState((r(o = {}, e, n + 1), r(o, "timer", 60 * n + 60), o))
                        }
                }
            }, {
                key: "timerControl",
                value: function () {
                    "stopped" === this.state.timerState ? (this.beginCountDown(), this.setState({
                        timerState: "running"
                    })) : (this.setState({
                        timerState: "stopped"
                ...
                value: function () {
                    ...
                    this.setState({
                        intervalID: (e = function () {
                            o.decrementTimer(), o.phaseControl()
                        }, t = 1e3, r = (new Date).getTime() + t, i = null, a = function () {
                            return r += t, i = setTimeout(a, r - (new Date).getTime()), e()
                        }, n = function () {
                ...
                value: function () {
                    ...
                    this.warning(e), this.buzzer(e), e < 0 && (this.state.intervalID && this.state.intervalID.cancel(), "Session" === this.state.timerType ? (this.beginCountDown(), this.switchTimer(60 * this.state.brkLength, "Break")) : (this.beginCountDown(), this.switchTimer(60 * this.state.seshLength, "Session")))
                }
            }, {
                key: "warning",
                value: function (e) {
                ...
                value: function () {
                    ...
                    }), this.state.intervalID && this.state.intervalID.cancel(), this.audioBeep.pause(), this.audioBeep.currentTime = 0
                }
            }, {
                key: "render",
                value: function () {
                    ...
                    }, "25 + 5 Clock"), React.createElement(h, {
